...
def generate_launch_description():
    ...
    base_frame = camera_name + '_base_link'
    ...
    zed_wrapper_launch = IncludeLaunchDescription(
        launch_description_source=PythonLaunchDescriptionSource([
            get_package_share_directory('zed_multi_camera'),
            '/launch/include/zed_camera_mod.launch.py'
        ]),
        launch_arguments={
            ...
            'cam_pitch': cam_pitch,
            'cam_yaw': cam_yaw,
            #'camera_sn': LaunchConfiguration('camera_sn', default=28846348),
            #'pos_tracking': 'false'
            #'pos_tracking': LaunchConfiguration('pos_tracking', default=False)
        }.items()
    )
