...
def generate_launch_description():
    ...
    #pos_tracking = LaunchConfiguration('pos_tracking')
    #print(f"*********pos tracking {pos_tracking}")
    ...
    #declare_sn_cmd = DeclareLaunchArgument(
    #    'camera_sn',
    #    default_value='',
    ...
    #    'pos_tracking',
    #    default_value='',
    #    description='Enable position tracking.')
    ...
    zed_wrapper_node = Node(
        ...
        parameters=[
            ...
            # Overriding
            {
                ...
                #'general.serial_number': camera_sn,
                'pos_tracking.base_frame': base_frame,
                #'pos_tracking.pose_tracking_enabed': pos_tracking
            }
        ]
    )
    ...
    #ld.add_action(declare_sn_cmd)
    #ld.add_action(declare_pos_cmd)
